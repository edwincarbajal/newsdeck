...
export default class Tag extends Component {
    ...
    render() {
        ...
        return (
            <div key={this.props.tagName} style={linkStyle} onClick={this.toggleChosen} onMouseEnter={this.toggleHover} onMouseLeave={this.toggleHover} className="TagContainer">
